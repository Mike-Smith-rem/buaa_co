...
LAB20:    t327 = (t0 + 3512);
    ...
    t331 = *((char **)t330);
    memcpy(t331, t3, 8);
    xsi_driver_vfirst_trans(t327, 0, 31);
    t332 = (t0 + 3416);
    *((int *)t332) = 1;
...
LAB90:    xsi_vlog_unsigned_bit_combine(t213, 32, t246, 32, t251, 32);
    goto LAB94;
...
LAB120:    t319 = (t0 + 1368U);
    t320 = *((char **)t319);
    t319 = ((char*)((ng8)));
    memset(t321, 0, 8);
    xsi_vlog_unsigned_lshift(t321, 32, t320, 32, t319, 32);
    goto LAB121;

LAB122:    t326 = ((char*)((ng9)));
    goto LAB123;

LAB124:    xsi_vlog_unsigned_bit_combine(t289, 32, t321, 32, t326, 32);
    goto LAB128;

LAB126:    memcpy(t289, t321, 8);
    goto LAB128;
...
extern void work_m_00000000003951261888_0886308060_init()
{
	...
	xsi_register_didat("work_m_00000000003951261888_0886308060", "isim/testbench_isim_beh.exe.sim/work/m_00000000003951261888_0886308060.didat");
